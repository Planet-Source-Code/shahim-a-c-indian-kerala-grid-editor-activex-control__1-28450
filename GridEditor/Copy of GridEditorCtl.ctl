...
Begin VB.UserControl GridEditor 
   ...
   Begin VB.PictureBox Picture1 
      ...
      End
   End
   Begin axButtonControl.axButton CmdFull 
      Height          =   375
      Left            =   855
      TabIndex        =   18
      Top             =   15
      ...
      FlatPicture     =   "GridEditorCtl.ctx":0865
      PictureAlign    =   0
      Caption         =   "Full &View"
      MaskColor       =   -2147483633
   End
   Begin axButtonControl.axButton Cmd_Close 
      Height          =   375
      Left            =   1905
      TabIndex        =   17
      Top             =   15
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "GridEditorCtl.ctx":0DA7
      FlatPicture     =   "GridEditorCtl.ctx":0F01
      PictureAlign    =   0
      Caption         =   "&Close"
      MaskColor       =   -2147483633
   End
   Begin axButtonControl.axButton Cmd_Print 
      Height          =   375
      Left            =   0
      TabIndex        =   16
      Top             =   15
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Picture         =   "GridEditorCtl.ctx":105B
      FlatPicture     =   "GridEditorCtl.ctx":159D
      PictureAlign    =   0
      Caption         =   "&Print"
      MaskColor       =   -2147483633
   End
   ...
   Begin MSComctlLib.ImageList ImageList1 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GridEditorCtl.ctx":1ADF
            Key             =   ""
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "GridEditorCtl.ctx":1D39
            Key             =   ""
         EndProperty
      EndProperty
   End
